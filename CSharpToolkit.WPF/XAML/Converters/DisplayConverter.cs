namespace CSharpToolkit.XAML.Converters {
    ...
    public class DisplayConverter : IValueConverter {
        ...
        /// <returns>Returns TrueValue or FalseValue depending if value is found, and status of InvertOutputToConvert.</returns>
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture) {
            bool convertSuccess = (bool)_converter.Convert(value, targetType, parameter, culture);
            return convertSuccess ? TrueValue : FalseValue; 
        }
        ...
        /// <summary>
        /// The value to output if the value is not found, and InvertOutputToConvert is false. 
        /// </summary>
