namespace CSharpToolkit.Utilities {
    ...
    public static class Perform {
        ...
        /// <param name="propertyName">Property name to transfer</param>
        /// <returns>Operation result.</returns>
        public static OperationResult PropertyAssignmentThroughReflection(object source, object dest, string propertyName) =>
            PropertyAssignmentThroughReflection(new KeyValuePair<object, string>(source, propertyName), new KeyValuePair<object, string>(dest, propertyName));
        ...
        /// <param name="source">Source object.</param>
        /// <param name="dest">Destination object.</param>
        /// <param name="sourcePropertyName">Property name on <paramref name="source"/> to copy.</param>
        /// <param name="destPropertyName">Property name on <paramref name="dest"/> to receive data.</param>
        /// <returns>Operation result.</returns>
        public static OperationResult PropertyAssignmentThroughReflection(object source, string sourcePropertyName, object dest, string destPropertyName) =>
            PropertyAssignmentThroughReflection(new KeyValuePair<object, string>(source, sourcePropertyName), new KeyValuePair<object, string>(dest, destPropertyName));
        ...
        /// <returns>An operation result containing a task whose result is a task that represents the async call. The nested inner Task should only be awaited. The outer Task can have Wait called on it to be synchronous.</returns>
        /// <exception>If the current synchronization context is null, and has been elected to be used, </exception>
        public static OperationResult<Task> TaskInvocationOfMethod(Action task, bool useCurrentSynchronization = true) =>
            Get.OperationResult(() => {
                TaskScheduler scheduler = TaskScheduler.Default;
