namespace CSharpToolkit.DataAccess.Web {
    ...
    /// </summary>
    public class PostWebClient : Abstractions.IWebDataRequestor {
        /// <summary>
        /// Makes a POST web call using the ContentType of "application/x-www-form-urlencoded". Combines data in following form : var1=val1&amp;var2=val2&amp;var3=val3
        /// </summary>
        ...
        public OperationResult<byte[]> MakeWebRequest(string url, IEnumerable<Tuple<string, string>> data, IEnumerable<Tuple<HttpRequestHeader, string>> requestHeaders = null) {
            ...
            byte[] postData = System.Text.Encoding.ASCII.GetBytes(string.Join("&", data.Select(d => $"{d.Item1}={d.Item2}")));
