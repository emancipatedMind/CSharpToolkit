namespace CSharpToolkit.Extensions {
    ...
    public static class UtilityExtensions {
        ...
        public static void LockForDuration(this ILocker locker, Func<Task> method) =>
            LockForDuration(locker, new object(), method);
        public static void LockForDuration(this ILocker locker, object token, Func<Task> method) {
            locker.RequestLock(token);
            method();
            locker.RequestUnlock(token);
        }
