namespace CSharpToolkit.Logging {
    ...
    /// <summary>
    /// Used as a Decorator for the IDataAccessor that will log requests as valid T-SQL.
    /// </summary>
    public class SQLLoggingDataAccessor : IDataAccessor {
        ...
        public SQLLoggingDataAccessor(IDataAccessor component, string fileName) : this(component, new TimeStampLogger(fileName) { LinePrependageText = "\r\n" }) { }
        ...
        public SQLLoggingDataAccessor(IDataAccessor component, ILogger logger) {
